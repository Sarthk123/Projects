...
var ASM_CONSTS = {
  100622: () => { if (document.fullscreenElement) return 1; },  
 100668: () => { return Module.canvas.width; },  
 100700: () => { return parseInt(Module.canvas.style.width); },  
 100748: () => { document.exitFullscreen(); },  
 100775: () => { setTimeout(function(){ Module.requestFullscreen(false, false); }, 100); },  
 100847: () => { if (document.fullscreenElement) return 1; },  
 100893: () => { return Module.canvas.width; },  
 100925: () => { return screen.width; },  
 100950: () => { document.exitFullscreen(); },  
 100977: ($0) => { const canvasId = UTF8ToString($0); setTimeout(function() { Module.requestFullscreen(false, true); setTimeout(function() { document.querySelector(canvasId).style.width="unset"; }, 100); }, 100); },  
 101171: () => { return window.innerWidth; },  
 101197: () => { return window.innerHeight; },  
 101224: () => { if (document.fullscreenElement) return 1; },  
 101270: () => { return Module.canvas.width; },  
 101302: () => { return parseInt(Module.canvas.style.width); },  
 101350: () => { if (document.fullscreenElement) return 1; },  
 101396: () => { return Module.canvas.width; },  
 101428: () => { return screen.width; },  
 101453: () => { return window.innerWidth; },  
 101479: () => { return window.innerHeight; },  
 101506: () => { if (document.fullscreenElement) return 1; },  
 101552: () => { return Module.canvas.width; },  
 101584: () => { return screen.width; },  
 101609: () => { document.exitFullscreen(); },  
 101636: () => { if (document.fullscreenElement) return 1; },  
 101682: () => { return Module.canvas.width; },  
 101714: () => { return parseInt(Module.canvas.style.width); },  
 101762: () => { document.exitFullscreen(); },  
 101789: ($0) => { Module.canvas.style.opacity = $0; },  
 101827: () => { return screen.width; },  
 101852: () => { return screen.height; },  
 101878: () => { return window.screenX; },  
 101905: () => { return window.screenY; },  
 101932: () => { return window.devicePixelRatio; },  
 101968: ($0) => { navigator.clipboard.writeText(UTF8ToString($0)); },  
 102021: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 102072: () => { Module.canvas.style.cursor = 'none'; },  
 102109: ($0, $1, $2, $3) => { try { navigator.getGamepads()[$0].vibrationActuator.playEffect('dual-rumble', { startDelay: 0, duration: $3, weakMagnitude: $1, strongMagnitude: $2 }); } catch (e) { try { navigator.getGamepads()[$0].hapticActuators[0].pulse($2, $3); } catch (e) { } } },  
 102365: ($0) => { Module.canvas.style.cursor = UTF8ToString($0); },  
 102416: () => { if (document.pointerLockElement) return 1; },  
 102463: () => { if (document.fullscreenElement) return 1; },  
 102509: () => { return window.innerWidth; },  
 102535: () => { return window.innerHeight; }
};
